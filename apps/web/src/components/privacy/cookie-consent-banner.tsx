...
export function CookieConsentBanner() {
  ...
  return (
    <div
      className="border-border bg-card/95 fixed inset-x-0 bottom-0 z-50 border-t p-4 shadow-2xl backdrop-blur-md"
      role="dialog"
      aria-label="رضایت کوکی"
    >
      <div className="mx-auto flex max-w-5xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-muted-foreground text-sm leading-relaxed">
          کوکی‌های ضروری برای کارکرد سایت لازم‌اند. کوکی‌های تحلیلی فقط با رضایت شما فعال می‌شوند.{' '}
